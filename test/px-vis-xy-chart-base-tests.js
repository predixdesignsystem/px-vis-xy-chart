...
function runBaseTests() {
  px_vis_xy_chart_1 = document.getElementById('px_vis_xy_chart_1');

  suite('Base Automation Tests for px-vis-xy-chart', function() {

    test('Polymer exists', function() {
      assert.isTrue(Polymer !== null);
    });
    test('px-vis-xy-chart fixture is created', function() {
      assert.isTrue(document.getElementById('px_vis_xy_chart_1') !== null);
    });
